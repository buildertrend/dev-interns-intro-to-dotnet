...
namespace Blackjack
{
    public class Game
    {
        ...
        private readonly List<string> suits = new List<string> { "Hearts", "Clubs", "Diamonds", "Spades" };
        ...
        {
            Console.WriteLine("How many additional players would you like (0-4) ?");
            var playerCount = Int32.Parse(Console.ReadLine().ToUpper());
        ...
        {
            var highestPlayer = _players.Where(x => x.total < 21).MaxBy(x => x.total);
            ...
            foreach(Player player in _players)
            {
                ...
                {
                    Console.WriteLine("Player {0} won the game! The dealer's total is {1} ", player.playerId, _dealerTotal);
                }
            }
        }
